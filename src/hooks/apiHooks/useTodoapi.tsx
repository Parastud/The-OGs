...
export default function useAuthApi(): useAuthApiReturnType {
    ...
    const createTodos = async (payload: any) => {
        ...
        try {
            ...
            dispatch(showSnackbarSuccess({ message: "Task added successfully " })); 
    ...
    const deleteTodo = async (id: string) => {
        ...
        try {
            ...
            dispatch(showSnackbarSuccess({ message: "Task deleted successfully" }));
    ...
    const toggleTodo = async (id: string) => {
        ...
        try {
            ...
            dispatch(showSnackbarSuccess({ message: "Task updated" }));
            return res; // ✅ return { success, message, data }
        } catch (error) {
            dispatch(showSnackbarError({ message: getErrorMessage(error) }));
            return null;
