...
export default function ProviderOnboarding1() {
    ...
    const {
        form,
        setName, setCity, setExperience, setBio, setPhotoUri,
        handleCategorySelect, toggleSkill, toggleLanguage,
    ...
    return (
        ...
        >
            ...
            >
                ...
                <ProfilePhotoUpload
                    uri={form.photoUri}
                    onPress={() => { /* wire image picker here */ }}
                />
...
const styles = StyleSheet.create({
    ...
    step: { fontFamily: FONTS.BOLD, fontSize: 11, color: Colors.primary, letterSpacing: 1.5, marginBottom: 8 },
    title: { fontFamily: FONTS.BOLD, fontSize: 26, color: Colors.textPrimary, marginBottom: 8, lineHeight: 32 },
    subtitle: { fontFamily: FONTS.REGULAR, fontSize: 14, color: Colors.textTertiary, lineHeight: 22 },
    ...
    expLabel: { fontFamily: FONTS.REGULAR, fontSize: 13, color: Colors.textPrimary },
    expLabelActive: { color: '#fff', fontFamily: FONTS.BOLD },
    emptyHint: { fontFamily: FONTS.REGULAR, fontSize: 13, color: Colors.textTertiary, lineHeight: 20 },
    charCount: { fontFamily: FONTS.REGULAR, fontSize: 12, color: Colors.textTertiary, textAlign: 'right', marginTop: 6 },
    ctaWrap: { marginTop: 32, marginBottom: 40 },
    cta: { backgroundColor: Colors.primary, borderRadius: 16, height: 56, alignItems: 'center', justifyContent: 'center' },
