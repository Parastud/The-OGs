...
export default function SettingsScreen() {
  ...
  const renderSettingItem = (Icon: any, title: string, action?: any, isDanger?: boolean) => (
...
const styles = StyleSheet.create({
  ...
  sectionHeading: { fontSize: 13, fontFamily: FONTS.BOLD, color: "#9CA3AF", textTransform: "uppercase", letterSpacing: 1, marginTop: 16, marginBottom: 10 },
  settingItem: { flexDirection: "row", alignItems: "center", paddingVertical: 12 },
  iconBox: { width: 40, height: 40, borderRadius: 12, backgroundColor: "#ECEBFF", alignItems: "center", justifyContent: "center", marginRight: 14 },
  iconBoxDanger: { backgroundColor: "#FEE2E2" },
  settingTitle: { flex: 1, fontSize: 16, fontFamily: FONTS.SEMIBOLD, color: "#1F2937" },
